...
`,[N("&:first-child",{marginTop:0}),K("prefix-bar",{position:"relative",paddingLeft:"var(--n-prefix-width)"},[K("align-text",{paddingLeft:0},[N("&::before",{left:"calc(-1 * var(--n-prefix-width))"})]),N("&::before",`
 ...
 bottom: 0;
 position: absolute;
 `),N("&::before",{backgroundColor:"var(--n-bar-color)"})])]),sp=Object.assign(Object.assign({},pe.props),{type:{type:String,default:"default"},prefix:String,alignText:Boolean}),bo=e=>te({name:`H${e}`,props:sp,setup(t){const{mergedClsPrefixRef:o,inlineThemeDisabled:n}=_e(t),r=pe("Typography","-h",lp,ln,t,o),i=z(()=>{const{type:a}=t,{common:{cubicBezierEaseInOut:s},self:{headerFontWeight:c,headerTextColor:u,[Z("headerPrefixWidth",e)]:h,[Z("headerFontSize",e)]:p,[Z("headerMargin",e)]:v,[Z("headerBarWidth",e)]:f,[Z("headerBarColor",a)]:b}}=r.value;return{"--n-bezier":s,"--n-font-size":p,"--n-margin":v,"--n-bar-color":b,"--n-bar-width":f,"--n-font-weight":c,"--n-text-color":u,"--n-prefix-width":h}}),l=n?qe(`h${e}`,z(()=>t.type[0]),i,t):void 0;return{mergedClsPrefix:o,cssVars:n?void 0:i,themeClass:l==null?void 0:l.themeClass,onRender:l==null?void 0:l.onRender}},render(){var t;const{prefix:o,alignText:n,mergedClsPrefix:r,cssVars:i,$slots:l}=this;return(t=this.onRender)===null||t===void 0||t.call(this),d(`h${e}`,{class:[`${r}-h`,`${r}-h${e}`,this.themeClass,{[`${r}-h--prefix-bar`]:o,[`${r}-h--align-text`]:n}],style:i},l)}}),dp=bo("1"),Ti=bo("2");bo("3");bo("4");bo("5");bo("6");const cp=T("a",`
 cursor: pointer;
 transition:
 color .3s var(--n-bezier),
 text-decoration-color .3s var(--n-bezier);
 ...
 color: var(--n-text-color);
`),up=Object.assign({},pe.props),lo=te({name:"A",props:up,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=_e(e),n=pe("Typography","-a",cp,ln,e,t),r=z(()=>{const{common:{cubicBezierEaseInOut:l},self:{aTextColor:a}}=n.value;return{"--n-text-color":a,"--n-bezier":l}}),i=o?qe("a",void 0,r,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),d("a",{class:[`${this.mergedClsPrefix}-a`,this.themeClass],style:this.cssVars},this.$slots)}}),fp=T("p",`
 box-sizing: border-box;
 transition: color .3s var(--n-bezier);
 margin: var(--n-margin);
 font-size: var(--n-font-size);
 line-height: var(--n-line-height);
 color: var(--n-text-color);
`,[N("&:first-child","margin-top: 0;"),N("&:last-child","margin-bottom: 0;")]),hp=Object.assign(Object.assign({},pe.props),{depth:[String,Number]}),Mn=te({name:"P",props:hp,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=_e(e),n=pe("Typography","-p",fp,ln,e,t),r=z(()=>{const{depth:l}=e,a=l||"1",{common:{cubicBezierEaseInOut:s},self:{pFontSize:c,pLineHeight:u,pMargin:h,pTextColor:p,[`pTextColor${a}Depth`]:v}}=n.value;return{"--n-bezier":s,"--n-font-size":c,"--n-line-height":u,"--n-margin":h,"--n-text-color":l===void 0?p:v}}),i=o?qe("p",z(()=>`${e.depth||""}`),r,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),d("p",{class:[`${this.mergedClsPrefix}-p`,this.themeClass],style:this.cssVars},this.$slots)}}),Fi=N("li",{transition:"color .3s var(--n-bezier)",lineHeight:"var(--n-line-height)",margin:"var(--n-li-margin)",marginBottom:0,color:"var(--n-text-color)"}),Mi=[N("&:first-child",`
 margin-top: 0;
 `),N("&:last-child",`
 margin-bottom: 0;
 `)],vp=N([T("ol",{fontSize:"var(--n-font-size)",padding:"var(--n-ol-padding)"},[K("align-text",{paddingLeft:0}),Fi,Mi]),T("ul",{fontSize:"var(--n-font-size)",padding:"var(--n-ul-padding)"},[K("align-text",{paddingLeft:0}),Fi,Mi])]),pp=Object.assign(Object.assign({},pe.props),{alignText:Boolean}),gp=te({name:"Ul",props:pp,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=_e(e),n=pe("Typography","-xl",vp,ln,e,t),r=z(()=>{const{common:{cubicBezierEaseInOut:l},self:{olPadding:a,ulPadding:s,liMargin:c,liTextColor:u,liLineHeight:h,liFontSize:p}}=n.value;return{"--n-bezier":l,"--n-font-size":p,"--n-line-height":h,"--n-text-color":u,"--n-li-margin":c,"--n-ol-padding":a,"--n-ul-padding":s}}),i=o?qe("ul",void 0,r,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;const{mergedClsPrefix:t}=this;return(e=this.onRender)===null||e===void 0||e.call(this),d("ul",{class:[`${t}-ul`,this.themeClass,this.alignText&&`${t}-ul--align-text`],style:this.cssVars},this.$slots)}}),No=te({name:"Li",render(){return d("li",null,this.$slots)}}),bp={id:"home-container"},mp={key:0},xp=te({__name:"HomeView",setup(e){const t=Jl(),o=ap();console.log(t.currentRoute.value.params.file);const n=L(""),r=L([]),i=[{type:"expand",renderExpand:a=>{let s="";const c=a.history;for(const u in c){const h=c[u],p=h.rank===1?"+INF":String(h.perf);s+=`${h.oldRating} -> ${h.newRating}，表现分 ${p}，排名 ${h.rank}，${h.contestName}。
`}return d(ip,{log:`logs:
${s}`})}},{title:"姓名",key:"handle",sorter:"default"},{title:"Rating",key:"rating",sorter:{compare:(a,s)=>a.rating-s.rating,multiple:1},defaultSortOrder:"descend"},{title:"Max Rating",key:"maxRating",sorter:{compare:(a,s)=>a.maxRating-s.maxRating,multiple:2}},{title:"参赛场数",key:"num",sorter:{compare:(a,s)=>a.num-s.num,multiple:3}}];Le(()=>t.currentRoute.value.params,(a,s)=>{console.log(a),n.value=String(a.file),l(n.value)});const l=a=>{a!=="error"&&(a=window.location.origin+window.location.pathname+`/${a}.json`,fetch(a).then(s=>s.json()).then(s=>{let c=[];for(let u in s){let h=s[u];h.num=h.history.length,c.push(s[u])}c=c.sort((u,h)=>h.rating-u.rating),console.log(c),r.value=c}).catch(s=>{console.error(s),o.error("加载失败")}))};return gt(()=>{n.value=t.currentRoute.value.params.file,l(n.value)}),(a,s)=>(Tr(),Fr("div",bp,[it(Ue(dp),null,{default:dt(()=>[ot(" ZAFU ACM 积分榜 ")]),_:1}),it(Ue(Mn),null,{default:dt(()=>[ot(" 积分使用 "),it(Ue(lo),{href:"https://en.wikipedia.org/wiki/Elo_rating_system"},{default:dt(()=>[ot("Elo Rating System")]),_:1}),ot("，仿照 CodeForces 的 Rating 计算方法。详细算法请访问 "),it(Ue(lo),{href:"https://github.com/zafuacm/rating"},{default:dt(()=>[ot(" 项目主页 ")]),_:1}),ot("。 ")]),_:1}),it(Ue(Ti),null,{default:dt(()=>[ot(" 赛季 ")]),_:1}),it(Ue(Mn),null,{default:dt(()=>[ot(" 我们会在每年一月份重新计分。 ")]),_:1}),it(Ue(Mn),null,{default:dt(()=>[it(Ue(gp),null,{default:dt(()=>[it(Ue(No),null,{default:dt(()=>[it(Ue(lo),{onClick:s[0]||(s[0]=c=>Ue(t).push("/list/2024-all"))},{default:dt(()=>[ot("2024 赛季")]),_:1}),ot("。 ")]),_:1}),it(Ue(No),null,{default:dt(()=>[it(Ue(lo),{onClick:s[1]||(s[1]=c=>Ue(t).push("/list/2023-all"))},{default:dt(()=>[ot("2023 赛季")]),_:1}),ot("。 ")]),_:1}),it(Ue(No),null,{default:dt(()=>[it(Ue(lo),{onClick:s[2]||(s[2]=c=>Ue(t).push("/list/2022-all"))},{default:dt(()=>[ot("2022 赛季（非正式）")]),_:1}),ot("。 ")]),_:1}),it(Ue(No),null,{default:dt(()=>[it(Ue(lo),{onClick:s[3]||(s[3]=c=>Ue(t).push("/list/2021-all"))},{default:dt(()=>[ot("2021 赛季（非正式）")]),_:1}),ot("。 ")]),_:1})]),_:1})]),_:1}),n.value!=="error"?(Tr(),Fr("div",mp,[it(Ue(Ti),null,{default:dt(()=>[ot(" Rating ")]),_:1}),it(Ue(qv),{columns:i,data:r.value,"row-key":c=>c.handle},null,8,["data","row-key"])])):Ql("",!0)]))}}),Cp=es(xp,[["__scopeId","data-v-ac62ec2e"]]);export{Cp as default};
