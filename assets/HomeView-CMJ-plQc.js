...
`,[N("&:first-child",{marginTop:0}),K("prefix-bar",{position:"relative",paddingLeft:"var(--n-prefix-width)"},[K("align-text",{paddingLeft:0},[N("&::before",{left:"calc(-1 * var(--n-prefix-width))"})]),N("&::before",`
 ...
 color: var(--n-text-color);
`),up=Object.assign({},pe.props),to=te({name:"A",props:up,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=_e(e),n=pe("Typography","-a",cp,ln,e,t),r=z(()=>{const{common:{cubicBezierEaseInOut:l},self:{aTextColor:a}}=n.value;return{"--n-text-color":a,"--n-bezier":l}}),i=o?qe("a",void 0,r,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),d("a",{class:[`${this.mergedClsPrefix}-a`,this.themeClass],style:this.cssVars},this.$slots)}}),fp=T("p",`
 box-sizing: border-box;
 transition: color .3s var(--n-bezier);
 margin: var(--n-margin);
 font-size: var(--n-font-size);
...
${s}`})}},{title:"姓名",key:"handle",sorter:"default"},{title:"Rating",key:"rating",sorter:{compare:(a,s)=>a.rating-s.rating,multiple:1},defaultSortOrder:"descend"},{title:"Max Rating",key:"maxRating",sorter:{compare:(a,s)=>a.maxRating-s.maxRating,multiple:2}},{title:"参赛场数",key:"num",sorter:{compare:(a,s)=>a.num-s.num,multiple:3}}];Le(()=>t.currentRoute.value.params,(a,s)=>{console.log(a),n.value=String(a.file),l(n.value)});const l=a=>{a!=="error"&&(a=window.location.origin+window.location.pathname+`/${a}.json`,fetch(a).then(s=>s.json()).then(s=>{let c=[];for(let u in s){let h=s[u];h.num=h.history.length,c.push(s[u])}c=c.sort((u,h)=>h.rating-u.rating),console.log(c),r.value=c}).catch(s=>{console.error(s),o.error("加载失败")}))};return gt(()=>{n.value=t.currentRoute.value.params.file,l(n.value)}),(a,s)=>(Tr(),Fr("div",bp,[tt(Ke(dp),null,{default:nt(()=>[Ye(" ZAFU ACM 积分榜 ")]),_:1}),tt(Ke(Mn),null,{default:nt(()=>[Ye(" 积分使用 "),tt(Ke(to),{href:"https://en.wikipedia.org/wiki/Elo_rating_system"},{default:nt(()=>[Ye("Elo Rating System")]),_:1}),Ye("，仿照 CodeForces 的 Rating 计算方法。详细算法请访问 "),tt(Ke(to),{href:"https://github.com/zafuacm/rating"},{default:nt(()=>[Ye(" 项目主页 ")]),_:1}),Ye("。 ")]),_:1}),tt(Ke(Ti),null,{default:nt(()=>[Ye(" 赛季 ")]),_:1}),tt(Ke(Mn),null,{default:nt(()=>[Ye(" 我们会在每年一月份重新计分。 ")]),_:1}),tt(Ke(Mn),null,{default:nt(()=>[tt(Ke(gp),null,{default:nt(()=>[tt(Ke(Ro),null,{default:nt(()=>[tt(Ke(to),{onClick:s[0]||(s[0]=c=>Ke(t).push("/list/2024-summer"))},{default:nt(()=>[Ye("2024 暑期组队")]),_:1}),Ye("。 ")]),_:1}),tt(Ke(Ro),null,{default:nt(()=>[tt(Ke(to),{onClick:s[1]||(s[1]=c=>Ke(t).push("/list/2024-all"))},{default:nt(()=>[Ye("2024 赛季")]),_:1}),Ye("。 ")]),_:1}),tt(Ke(Ro),null,{default:nt(()=>[tt(Ke(to),{onClick:s[2]||(s[2]=c=>Ke(t).push("/list/2023-all"))},{default:nt(()=>[Ye("2023 赛季")]),_:1}),Ye("。 ")]),_:1}),tt(Ke(Ro),null,{default:nt(()=>[tt(Ke(to),{onClick:s[3]||(s[3]=c=>Ke(t).push("/list/2022-all"))},{default:nt(()=>[Ye("2022 赛季（非正式）")]),_:1}),Ye("。 ")]),_:1}),tt(Ke(Ro),null,{default:nt(()=>[tt(Ke(to),{onClick:s[4]||(s[4]=c=>Ke(t).push("/list/2021-all"))},{default:nt(()=>[Ye("2021 赛季（非正式）")]),_:1}),Ye("。 ")]),_:1})]),_:1})]),_:1}),n.value!=="error"?(Tr(),Fr("div",mp,[tt(Ke(Ti),null,{default:nt(()=>[Ye(" Rating ")]),_:1}),tt(Ke(qv),{columns:i,data:r.value,"row-key":c=>c.handle},null,8,["data","row-key"])])):Ql("",!0)]))}}),Cp=es(xp,[["__scopeId","data-v-a02f27c1"]]);export{Cp as default};
