...
`,[F("pagination-prefix",`
 ...
 `)]),Ae("disabled",[K("hover",vi,pi),H("&:hover",vi,pi),H("&:active",`
...
`,[H("&:first-child",{marginTop:0}),K("prefix-bar",{position:"relative",paddingLeft:"var(--n-prefix-width)"},[K("align-text",{paddingLeft:0},[H("&::before",{left:"calc(-1 * var(--n-prefix-width))"})]),H("&::before",`
 ...
 color: var(--n-text-color);
`),cp=Object.assign({},be.props),Oo=oe({name:"A",props:cp,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=Ie(e),n=be("Typography","-a",dp,Jo,e,t),r=T(()=>{const{common:{cubicBezierEaseInOut:l},self:{aTextColor:a}}=n.value;return{"--n-text-color":a,"--n-bezier":l}}),i=o?je("a",void 0,r,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),d("a",{class:[`${this.mergedClsPrefix}-a`,this.themeClass],style:this.cssVars},this.$slots)}}),up=F("p",`
 box-sizing: border-box;
 transition: color .3s var(--n-bezier);
 margin: var(--n-margin);
 font-size: var(--n-font-size);
 line-height: var(--n-line-height);
 color: var(--n-text-color);
`,[H("&:first-child","margin-top: 0;"),H("&:last-child","margin-bottom: 0;")]),fp=Object.assign(Object.assign({},be.props),{depth:[String,Number]}),zn=oe({name:"P",props:fp,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=Ie(e),n=be("Typography","-p",up,Jo,e,t),r=T(()=>{const{depth:l}=e,a=l||"1",{common:{cubicBezierEaseInOut:s},self:{pFontSize:c,pLineHeight:f,pMargin:u,pTextColor:p,[`pTextColor${a}Depth`]:v}}=n.value;return{"--n-bezier":s,"--n-font-size":c,"--n-line-height":f,"--n-margin":u,"--n-text-color":l===void 0?p:v}}),i=o?je("p",T(()=>`${e.depth||""}`),r,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;return(e=this.onRender)===null||e===void 0||e.call(this),d("p",{class:[`${this.mergedClsPrefix}-p`,this.themeClass],style:this.cssVars},this.$slots)}}),Pi=H("li",{transition:"color .3s var(--n-bezier)",lineHeight:"var(--n-line-height)",margin:"var(--n-li-margin)",marginBottom:0,color:"var(--n-text-color)"}),zi=[H("&:first-child",`
 margin-top: 0;
 `),H("&:last-child",`
 margin-bottom: 0;
 `)],hp=H([F("ol",{fontSize:"var(--n-font-size)",padding:"var(--n-ol-padding)"},[K("align-text",{paddingLeft:0}),Pi,zi]),F("ul",{fontSize:"var(--n-font-size)",padding:"var(--n-ul-padding)"},[K("align-text",{paddingLeft:0}),Pi,zi])]),vp=Object.assign(Object.assign({},be.props),{alignText:Boolean}),pp=oe({name:"Ul",props:vp,setup(e){const{mergedClsPrefixRef:t,inlineThemeDisabled:o}=Ie(e),n=be("Typography","-xl",hp,Jo,e,t),r=T(()=>{const{common:{cubicBezierEaseInOut:l},self:{olPadding:a,ulPadding:s,liMargin:c,liTextColor:f,liLineHeight:u,liFontSize:p}}=n.value;return{"--n-bezier":l,"--n-font-size":p,"--n-line-height":u,"--n-text-color":f,"--n-li-margin":c,"--n-ol-padding":a,"--n-ul-padding":s}}),i=o?je("ul",void 0,r,e):void 0;return{mergedClsPrefix:t,cssVars:o?void 0:r,themeClass:i==null?void 0:i.themeClass,onRender:i==null?void 0:i.onRender}},render(){var e;const{mergedClsPrefix:t}=this;return(e=this.onRender)===null||e===void 0||e.call(this),d("ul",{class:[`${t}-ul`,this.themeClass,this.alignText&&`${t}-ul--align-text`],style:this.cssVars},this.$slots)}}),$i=oe({name:"Li",render(){return d("li",null,this.$slots)}}),gp={id:"home-container"},bp={key:0},mp=oe({__name:"HomeView",setup(e){const t=Ul(),o=ip();console.log(t.currentRoute.value.params.file);const n=D(""),r=D([]),i=[{type:"expand",renderExpand:a=>{let s="";const c=a.history;for(const f in c){const u=c[f];console.log(u.rank,u.rank===1);const p=u.rank===1?"+INF":String(u.perf);s+=`${u.oldRating} -> ${u.newRating}，表现分 ${p}，排名 ${u.rank}，${u.contestName}。
`}return d(rp,{log:`logs:
${s}`})}},{title:"姓名",key:"handle",sorter:"default"},{title:"Rating",key:"rating",sorter:{compare:(a,s)=>a.rating-s.rating,multiple:1},defaultSortOrder:"descend"},{title:"Max Rating",key:"maxRating",sorter:{compare:(a,s)=>a.maxRating-s.maxRating,multiple:2}},{title:"参赛场数",key:"num",sorter:{compare:(a,s)=>a.num-s.num,multiple:3}}];Oe(()=>t.currentRoute.value.params,(a,s)=>{console.log(a),n.value=String(a.file),l(n.value)});const l=a=>{a!=="error"&&(a=window.location.origin+window.location.pathname+`/${a}.json`,fetch(a).then(s=>s.json()).then(s=>{let c=[];for(let f in s){let u=s[f];u.num=u.history.length,c.push(s[f])}c=c.sort((f,u)=>u.rating-f.rating),console.log(c),r.value=c}).catch(s=>{console.error(s),o.error("加载失败")}))};return gt(()=>{n.value=t.currentRoute.value.params.file,l(n.value)}),(a,s)=>(kr(),Rr("div",gp,[ut(it(sp),null,{default:ht(()=>[st(" ZAFU ACM 积分榜 ")]),_:1}),ut(it(zn),null,{default:ht(()=>[st(" 积分使用 "),ut(it(Oo),{href:"https://en.wikipedia.org/wiki/Elo_rating_system"},{default:ht(()=>[st("Elo Rating System")]),_:1}),st("，仿照 CodeForces 的 Rating 计算方法。详细算法请访问 "),ut(it(Oo),{href:"#"},{default:ht(()=>[st(" 项目主页 ")]),_:1}),st("。 ")]),_:1}),ut(it(Ri),null,{default:ht(()=>[st(" 赛季 ")]),_:1}),ut(it(zn),null,{default:ht(()=>[st(" 我们每个学年会重新计分。 ")]),_:1}),ut(it(zn),null,{default:ht(()=>[ut(it(pp),null,{default:ht(()=>[ut(it($i),null,{default:ht(()=>[ut(it(Oo),{onClick:s[0]||(s[0]=c=>it(t).push("/list/2022-all"))},{default:ht(()=>[st("2022 赛季")]),_:1}),st("。 ")]),_:1}),ut(it($i),null,{default:ht(()=>[ut(it(Oo),{onClick:s[1]||(s[1]=c=>it(t).push("/list/2021-all"))},{default:ht(()=>[st("2021 赛季")]),_:1}),st("。 ")]),_:1})]),_:1})]),_:1}),n.value!=="error"?(kr(),Rr("div",bp,[ut(it(Ri),null,{default:ht(()=>[st(" Rating ")]),_:1}),ut(it(Gv),{columns:i,data:r.value,"row-key":c=>c.handle},null,8,["data","row-key"])])):Vl("",!0)]))}});const yp=Gl(mp,[["__scopeId","data-v-290afb6c"]]);export{yp as default};
